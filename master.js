...
function drawEverything(){
  ...
  // left paddle
  colorRect(BUFFER, paddle1Y, PADDLE_WIDTH, PADDLE_HEIGHT, 'white');
  // right paddle
  colorRect(canvas.width - (PADDLE_WIDTH + BUFFER), ballY - (PADDLE_HEIGHT/2), PADDLE_WIDTH, PADDLE_HEIGHT, 'white');
   drawScore();
   drawNet();
